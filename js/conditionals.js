...
let total = parseFloat(prompt("What is your total?"));
...
if (confirm("Would you like to enter a number")) {
    ...
    if (!isNaN(parseInt(userInput))) {
        ...
        alert("That number + 100 is " + (parseInt(userInput) + 100));
        ...
        alert("Wrong input, the input you gave was type " + typeof(userInput));
    }
}